...
curl_setopt_array($ch, [
    ...
    CURLOPT_PROXY => 'http://gate.turnoxy.com:1318',
...
$proxy = 'http://gate.turnoxy.com:1318';
...
// Target Germany IPs
$client = new Client([
    'proxy' => 'http://sub_xxx-country-DE:pass@gate.turnoxy.com:1318'
]);
...
$context = stream_context_create([
    'http' => [
        'proxy' => 'tcp://gate.turnoxy.com:1318',
